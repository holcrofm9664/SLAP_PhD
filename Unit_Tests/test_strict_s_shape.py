...
class Test_model(unittest.TestCase):
    ...
    def test_output_type(self):
        ...
        model_status_result, distance_result, time_result, assignment_result = Strict_S_Shape(**instance)
    ...
    def test_instance_1(self): # feasible
        ...
        model_status_result, distance_result, _, _ = Strict_S_Shape(**instance)
        ...
        self.assertEqual(distance_result, 24, msg = f"model is obtaining the wrong final distance. Minimum distance is {24}. The model is achieving {distance_result}.")
    ...
    def test_instance_2(self): # feasible
        ...
        instance = {
            ...
            "between_aisle_dist":1,
            "between_bay_dist":1,
            "orders":{1:[1,2,3,4,5,6], 2:[7,8,9,10,11,12], 3:[1,2,3,7,8,9], 4:[4,5,6,10,11,12], 5:[1,2,3,11,12,13]}
        }
    ...
    def test_instance_3(self): # infeasible
        ...
        instance = {
            ...
            "between_aisle_dist":1,
            "between_bay_dist":1,
            "orders":{1:[1,2,3,4], 2:[5,6,7,8], 3:[9,10,11,12]}
        }

        model_status_result, _, _, _ = Strict_S_Shape(**instance)
    ...
    def test_instance_4(self): # feasible - first aisle only case
        instance = {
            ...
            "between_aisle_dist":1,
            "between_bay_dist":1,
            "orders":{1:[1,2,3], 2:[4,5,6], 3:[1,3,5]}
        }
        ...
        self.assertEqual(distance_result, 30, msg = f"model is obtaining the wrong final distance. Minimum distance is {30}. The model is achieving {distance_result}.")
